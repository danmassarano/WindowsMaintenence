...
Register-ScheduledTask -TaskName "WindowsMaintenenceStep1" -Trigger $Trigger -User $User -Action $Action -RunLevel Highest

$Argument = $location.Path + "\WindowsMaintenenceStep2.ps1"
$Trigger = New-ScheduledTaskTrigger -AtStartup
$Action = New-ScheduledTaskAction -Execute "PowerShell.exe" -Argument $Argument
Register-ScheduledTask -TaskName "WindowsMaintenenceStep2" -Trigger $Trigger -User $User -Action $Action -RunLevel Highest